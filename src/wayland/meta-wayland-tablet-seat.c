                   ...
                   MetaWaylandTabletTool *tool)
{
  ...
  wl_tablet_seat_send_tool_added (client_resource, tool_resource);
}
                     ...
                     ClutterInputDevice    *device)
{
  ...
  wl_tablet_seat_send_tablet_added (client_resource, resource);
}
                                              ...
                                              uint32_t               id)
{
  ...
  resource = wl_resource_create (client, &wl_tablet_seat_interface,
